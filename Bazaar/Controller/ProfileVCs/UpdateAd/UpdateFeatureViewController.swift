//
//  UpdateFeatureViewController.swift
//  Bazaar
//
...
class UpdateFeatureViewController: UIViewController {
...
//    @IBOutlet weak var nextBtn: UIButton!
    ...
    func loadData() {
        FeaturesService.instance.getunSelectedFeaturesFeatures(id: adId) { (error, features) in
...
extension UpdateFeatureViewController: UITableViewDelegate, UITableViewDataSource {
