...
class PaymentMethodsVC: UIViewController {
    ...
    func loadData() {
        PaymentMethodService.instance.getPaymentMethodsForAd(ad: adId) { (error, paymentMethods) in
...
extension PaymentMethodsVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        Alamofire.request(EXECUTEPAYMENTMETHODFORAD_URL, method: .post, parameters: parameters, encoding: URLEncoding.default, headers: HEADER_BOTH).responseString { (response) in
