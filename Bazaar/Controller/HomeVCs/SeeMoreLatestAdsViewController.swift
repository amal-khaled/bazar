//
//  SeeMoreLatestAdsViewController.swift
//  Bazaar
//
//  Created by Amal Elgalant on 27/12/2020.
...
import SDWebImage
class SeeMoreLatestAdsViewController: UIViewController {
    ...
    func loadData() {
        AdsService.instance.getLatestAds (page: page){ (error, allAds) in
...
extension SeeMoreLatestAdsViewController: UICollectionViewDelegate,UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
