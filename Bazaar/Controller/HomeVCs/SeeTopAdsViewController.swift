...
import SDWebImage
class SeeTopAdsViewController: UIViewController {
    ...
    func loadData() {
        AdsService.instance.getTopAds (page: page){ (error, allAds) in
...
extension SeeTopAdsViewController: UICollectionViewDelegate,UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
