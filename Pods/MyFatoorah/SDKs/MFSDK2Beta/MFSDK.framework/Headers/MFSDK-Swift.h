...
@interface MFPaymentRequest (SWIFT_EXTENSION(MFSDK))
- (void)executeApplePayPaymentWithRequest:(MFExecutePaymentRequest * _Nonnull)request urlScheme:(NSString * _Nonnull)urlScheme apiLanguage:(enum MFAPILanguage)apiLanguage completion:(void (^ _Nonnull)(MFPaymentStatusResponse * _Nullable, MFFailResponse * _Nullable, NSString * _Nullable))completion SWIFT_AVAILABILITY(ios,introduced=9.0);
@end
